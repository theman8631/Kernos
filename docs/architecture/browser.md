...
| `semantic_tree` | `page.accessibility.snapshot()` | Simplified by collapsing generic wrappers |
| `interactiveElements` | `page.accessibility.snapshot()` | Flattened to role-based interactive subset |
