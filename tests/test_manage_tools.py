"""Tests for SPEC-3K: Unified Capability Registry — manage_tools kernel tool."""
import json
import pytest
...
# ===========================
# Test: manage_tools list shows all with source and status
# ===========================

class TestManageToolsList:
    def test_list_shows_all_capabilities_with_source_and_status(self):
        """AC1: manage_tools list returns both default and user-installed capabilities."""
        ...
        result = asyncio.get_event_loop().run_until_complete(
            rs._handle_manage_tools("tenant_test", "list", "")
        )
...
# ===========================
# Test: Disable → tools absent from LLM list → manage_tools shows disabled
# ===========================
...
class TestReEnable:
    ...
    async def test_manage_tools_enable_action(self):
        """AC3: manage_tools enable action works."""
        from kernos.kernel.reasoning import ReasoningService
        ...
        result = await rs._handle_manage_tools("tenant_test", "enable", "cal")
...
class TestRemoveDefault:
    async def test_remove_default_returns_error(self):
        """AC4: manage_tools remove google-calendar returns error."""
        from kernos.kernel.reasoning import ReasoningService
        ...
        result = await rs._handle_manage_tools("tenant_test", "remove", "google-calendar")
...
class TestRemoveUser:
    async def test_remove_user_cap_succeeds(self):
        ...
        result = await rs._handle_manage_tools("tenant_test", "remove", "custom-tool")
...
class TestDisableUserAdded:
    async def test_disable_user_cap(self):
        ...
        result = await rs._handle_manage_tools("tenant_test", "disable", "custom-tool")
...
# ===========================
# Test: Gate classification for manage_tools
# ===========================
...
class TestManageToolsGateClassification:
    def test_list_is_read(self):
        ...
        rs = ReasoningService.__new__(ReasoningService)
        rs._registry = None
        effect = rs._classify_tool_effect("manage_tools", None, {"action": "list"})
        assert effect == "read"
    ...
    def test_enable_is_soft_write(self):
        ...
        rs = ReasoningService.__new__(ReasoningService)
        rs._registry = None
        effect = rs._classify_tool_effect("manage_tools", None, {"action": "enable"})
    ...
    def test_disable_is_soft_write(self):
        ...
        rs = ReasoningService.__new__(ReasoningService)
        rs._registry = None
        effect = rs._classify_tool_effect("manage_tools", None, {"action": "disable"})
        assert effect == "soft_write"
    ...
    def test_remove_is_soft_write(self):
        ...
        rs = ReasoningService.__new__(ReasoningService)
        rs._registry = None
        effect = rs._classify_tool_effect("manage_tools", None, {"action": "remove"})
        assert effect == "soft_write"
    ...
    def test_install_is_soft_write(self):
        ...
        rs = ReasoningService.__new__(ReasoningService)
        rs._registry = None
        effect = rs._classify_tool_effect("manage_tools", None, {"action": "install"})
        assert effect == "soft_write"


# ===========================
# Test: manage_tools in _KERNEL_TOOLS set
# ===========================

class TestKernelToolRegistration:
    def test_manage_tools_in_kernel_tools(self):
        from kernos.kernel.reasoning import ReasoningService
        assert "manage_tools" in ReasoningService._KERNEL_TOOLS

    def test_manage_tools_tool_definition_exists(self):
        from kernos.kernel.reasoning import MANAGE_TOOLS_TOOL
        assert MANAGE_TOOLS_TOOL["name"] == "manage_tools"
        schema = MANAGE_TOOLS_TOOL["input_schema"]
...
class TestManageToolsEdgeCases:
    ...
    async def test_disable_already_disabled(self):
        ...
        result = await rs._handle_manage_tools("tenant_test", "disable", "cal")
    ...
    async def test_unknown_capability(self):
        ...
        result = await rs._handle_manage_tools("tenant_test", "enable", "nonexistent")
    ...
    async def test_no_registry(self):
        ...
        result = await rs._handle_manage_tools("tenant_test", "list", "")
    ...
    async def test_missing_capability_for_action(self):
        ...
        result = await rs._handle_manage_tools("tenant_test", "enable", "")
    ...
    async def test_unknown_action(self):
        ...
        result = await rs._handle_manage_tools("tenant_test", "unknown_action", "")
